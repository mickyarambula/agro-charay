...
export default function EdoResultadosModule({ userRol, onNavigate }) {
  ...
  const rows = [
    ...
    { tipo:"item",    label:"Mano de obra y cuadrillas", valor:F.costoManoObra, mod:"gastos" },
    { tipo:"item",    label:"Pago de agua",              valor:F.costoAgua,     mod:"gastos" },
    { tipo:"item",    label:"Seguros",                   valor:F.costoSeguros,  mod:"gastos" },
    { tipo:"item",    label:"Trámites y permisos",       valor:F.costoTramites, mod:"gastos" },
    { tipo:"item",    label:"Otros gastos",              valor:F.costoOtros,    mod:"gastos" },
